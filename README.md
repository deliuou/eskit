...
`eskit` 是一个 **WSL 优先** 的 Windows 文件搜索命令行工具，支持 Python 和 Rust 两个版本。
...
| 版本 | 语言 | 安装方式 |
|------|------|---------|
| [eskit-python](eskit-python/) | Python 3.9+ | `pip install eskit-python` |
| [eskit-rust](eskit-rust/) | Rust | `cargo install eskit-rust` |
